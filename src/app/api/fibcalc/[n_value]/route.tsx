...
export async function GET(request: Request, {params} : {params: {n_value: string}}) {
    ...
    try {
        // conditional to ensure floats aren't used in the API call.
        if (params.n_value.includes('.')) return NextResponse.json({message: "Please input a whole number. No decimals."});
